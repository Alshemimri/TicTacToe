...
function ai() {
    ...
    // block traps 
    else if (getSquareValue(2) == player01Id && getSquareValue(6) == player01Id && getSquareValue(3) == '' && document.numberOfMoves < '3') {
        $square.eq(2).text(player02Id);
    }
    else if (getSquareValue(2) == player01Id && getSquareValue(4) == player01Id && getSquareValue(1) == '' && document.numberOfMoves < '3') {
        $square.eq(0).text(player02Id);
    }
    else if (getSquareValue(4) == player01Id && getSquareValue(8) == player01Id && getSquareValue(7) == '' && document.numberOfMoves < '3') {
        $square.eq(6).text(player02Id);
    }
    else if (getSquareValue(8) == player01Id && getSquareValue(6) == player01Id && getSquareValue(9) == '' && document.numberOfMoves < '3') {
        $square.eq(8).text(player02Id);
    }
    else if (getSquareValue(5) == player01Id && getSquareValue(9) == player01Id && document.numberOfMoves == '2') {
        $square.eq(6).text(player02Id);
    }
    // 2 in line
